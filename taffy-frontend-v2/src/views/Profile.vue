<template>
  <div class="page page-narrow">
    ...
    <div class="card" style="margin-top:16px">
      ...
      <div v-if="apiKey" style="display:flex;align-items:center;gap:8px;background:#f5f7fa;padding:12px;border-radius:8px">
...
<style scoped>
.api-code { background:#1e293b; color:#e2e8f0; padding:16px; border-radius:8px; font-size:13px; line-height:1.6; overflow-x:auto; white-space:pre; }
</style>
